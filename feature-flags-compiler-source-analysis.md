...
version: 1.0.0
date: 2026-03-03
source: ~/Developer/swiftlang/swift/
...
`~/Developer/swiftlang/swift/`. Each feature is evaluated by its definition
...
Source: `~/Developer/swiftlang/swift/include/swift/Basic/Features.def`
...
`~/Developer/swiftlang/swift/` on 2026-03-03. File counts are based on
