...
**Path:** `~/Developer/swift-primitives/swift-parser-primitives/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-9110/`
...
**Paths:** `~/Developer/swift-standards/swift-rfc-9111/`, `~/Developer/swift-standards/swift-rfc-9112/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-3986/`
...
**Path:** `~/Developer/swift-standards/swift-whatwg-url/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-6570/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-6068/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-2369/`
...
**Path:** `~/Developer/swift-standards/swift-iso-8601/`
...
**Transitive benefits:**
- RFC 3339 (at `~/Developer/swift-standards/swift-rfc-3339/`) delegates to ISO 8601 parsing — benefits automatically.

#### RFC 5322 Date/Time

**Package:** `swift-rfc-5322`
**Path:** `~/Developer/swift-standards/swift-rfc-5322/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-9557/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-5321/`
**Scope:** 2 parse functions
...
**Path:** `~/Developer/swift-standards/swift-rfc-2045/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-2183/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-2388/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-2822/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-6750/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-7617/`
**Scope:** 2 parse functions
...
**Path:** `~/Developer/swift-standards/swift-rfc-7519/`
...
**Path:** `~/Developer/swift-standards/swift-rfc-5646/`
...
**Path:** `~/Developer/swift-standards/swift-rss-standard/`
**Scope:** 1 parse function
...
**Path:** `~/Developer/swift-standards/swift-w3c-svg/`
...
- RFC 8259 `ParserPrinter.Prototype` — `~/Developer/swift-standards/swift-rfc-8259/Sources/RFC 8259/RFC_8259.ParserPrinter.Prototype.swift`
- W3C XML parser (most advanced adoption) — `~/Developer/swift-standards/swift-w3c-xml/Sources/W3C XML/W3C_XML.Parse.*.swift`
- Parser Primitives API — `~/Developer/swift-primitives/swift-parser-primitives/Sources/`
