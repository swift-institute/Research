...
- `~/Developer/swift-statute-nl/wet-zeggenschap-lichaamsmateriaal/` — Wzl MvT pattern exemplar
- `~/Developer/swift-institute/Skills/research-process/SKILL.md` — [RES-002]
- `~/Developer/swift-institute/Skills/experiment-process/SKILL.md` — [EXP-002]
