...
This research investigates the Swift compiler source (`~/Developer/swiftlang/swift`) to determine which pain points are fundamental, which are known bugs, and which have improvement paths.
