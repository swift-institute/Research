...
- `~/Developer/swift-primitives/swift-ordinal-primitives/Sources/Ordinal Primitives/Tagged+Ordinal.swift` — Extension init APIs
- `~/Developer/swift-primitives/swift-identity-primitives/Tests/Support/Identity Primitives Test Support.swift` — Literal conformances
- `~/Developer/swift-primitives/swift-pointer-primitives/Tests/Pointer Primitives Tests/Pointer Arithmetic Tests.swift` — Correct test patterns
- `~/Developer/swift-primitives/swift-storage-primitives/Tests/Storage Primitives Tests/Storage.Inline Tests.swift` — Anti-pattern examples
