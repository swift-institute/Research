...
**Trigger file**: `~/Developer/swift-foundations/swift-dependency-analysis/Sources/Dependency Analysis CLI/parallel.swift` — uses `IO.Blocking.Lane.threads()` for concurrent analysis.

**Workaround file**: `~/Developer/swift-foundations/swift-dependency-analysis/Sources/Dependency Analysis CLI/CLI.swift` — contains `withTaskGroup` calls, does NOT import `IO_Blocking_Threads`.
...
`String_Primitives.String` is defined at `~/Developer/swift-primitives/swift-string-primitives/Sources/String Primitives/String.swift`:
...
`ISO_9899.String` (at `~/Developer/swift-iso/swift-iso-9899/`) is complementary, not redundant:
...
Remove `@_exported public import String_Primitives` from `~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Primitives Core/exports.swift` (line 19).
...
3. `~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Primitives/Exports.swift` — change line 11 from `@_exported public import Kernel_String_Primitives` to `public import Kernel_String_Primitives`
4. `~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Environment Primitives/exports.swift` (line 5) — change to non-exported
...
1. **`~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Primitives Core/exports.swift`** (line 19):
   Remove `@_exported public import String_Primitives`

2. **`~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel String Primitives/Kernel.String.swift`**:
   Add `public import String_Primitives` at top

3. **`~/Developer/swift-primitives/swift-kernel-primitives/Package.swift`**:
   Add `"String Primitives"` as a direct dependency of the `"Kernel String Primitives"` target

4. **`~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Primitives/Exports.swift`** (line 11):
   Change `@_exported public import Kernel_String_Primitives` to `public import Kernel_String_Primitives`

5. **`~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Environment Primitives/exports.swift`** (line 5):
   Change `@_exported public import Kernel_String_Primitives` to `public import Kernel_String_Primitives`.
...
- [PRIM-FOUND-001] No Foundation — `~/Developer/swift-institute/Skills/primitives/SKILL.md`
...
- OS Native Path String Semantics — `~/Developer/swift-primitives/swift-string-primitives/Research/OS Native Path String Semantics.md`
