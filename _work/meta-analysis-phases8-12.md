...
All 6 required `.bib` files exist in `~/Developer/swift-institute/References/`:
...
Blog index at `~/Developer/swift-institute/REDACTED/_index.md` reviewed.
...
- `~/Developer/swift-institute/Research/audit.md` — Ecosystem-wide
- `~/Developer/swift-primitives/Research/audit.md` — Primitives-wide
