...
RECOMMENDATION documents checked against skills in `~/Developer/.claude/skills/`. A document is a supersession candidate when its recommendations are now codified as requirement IDs in a skill.
