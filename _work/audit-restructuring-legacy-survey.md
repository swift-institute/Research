...
- `~/Developer/swift-iso/swift-iso-9899/Research/audit.md` (P2 portion)
- `~/Developer/swift-iso/swift-iso-9945/Research/audit.md` (P2 portion)
- `~/Developer/swift-incits/swift-incits-4-1986/Research/audit.md` (P2 portion)
...
- `~/Developer/swift-foundations/swift-tests/Research/audit.md` — 46 violations
- `~/Developer/swift-foundations/swift-testing/Research/audit.md` — 42 violations
...
**Merge Target**: This is a **meta-document** that should live at `~/Developer/swift-foundations/Research/_work/` as a working artifact or instruction guide. It does NOT belong in any single package. Keep at institute level or in a _work directory for ongoing remediation tracking.
...
**Merge Target**: KEEP at institute level. This is a **meta-policy validation document** that tracks ecosystem stability. It should live at `~/Developer/swift-institute/Research/` or in `_work/` as a durable artifact. Not package-specific. Update it monthly to detect drift across the 132 primitives packages.
