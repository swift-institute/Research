...
- `Memory.Pool` — `~/Developer/swift-primitives/swift-memory-primitives/Sources/Memory Pool Primitives/Memory.Pool.swift`
- `Async.Bridge` — `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Bridge.swift`
