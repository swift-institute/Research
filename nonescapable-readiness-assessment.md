...
**swift-async-primitives** (`~/Developer/swift-primitives/swift-async-primitives/Package.swift`, line 64):
```swift
.enableExperimentalFeature("Lifetimes"),
```

**swift-async** (`~/Developer/swift-foundations/swift-async/Package.swift`, line 55):
```swift
.enableExperimentalFeature("Lifetimes"),
```
...
**File**: `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Waiter.Entry.swift`
...
**File**: `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Waiter Primitives/Async.Waiter.Resumption.swift`
...
**Files**:
- `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Channel.Bounded.Receiver.swift`
- `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Channel.Unbounded.Receiver.swift`
...
**Files**:
- `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Channel.Bounded.swift` (lines 135-178)
- `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Channel.Unbounded.swift` (lines 136-179)
...
**File**: `~/Developer/swift-foundations/swift-async/Sources/Async Stream/Async.Stream.Iterator.swift`
...
**File**: `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Callback.swift`
...
**File**: `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Publication.swift`
...
**File**: `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Broadcast.swift` (lines 212-325)
...
**File**: `~/Developer/swift-primitives/swift-async-primitives/Sources/Async Primitives/Async.Waiter.Queue.swift` (lines 81-125)
...
Related analysis in `~/Developer/swift-primitives/swift-memory-primitives/Research/lifetime-dependent-borrowed-cursors.md`.
...
- `~/Developer/swift-primitives/swift-memory-primitives/Research/lifetime-dependent-borrowed-cursors.md` -- Closure integration gap analysis
- `~/Developer/swift-primitives/swift-memory-primitives/Research/span-access-abstraction.md` -- Span access patterns
- `~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Primitives/Kernel.Path.View.swift` -- Existing ~Escapable type in ecosystem
- `~/Developer/swift-primitives/swift-sequence-primitives/Sources/Sequence Primitives Standard Library Integration/Swift.Span.Iterator.swift` -- Existing ~Escapable iterator
- `~/Developer/swift-primitives/swift-sequence-primitives/Sources/Sequence Primitives Core/Sequence.Map.swift` -- Canonical conditional Escapable pattern
- `~/Developer/swift-institute/Experiments/nonsending-blocker-validation-negative/` -- Experiment: ~Escapable edge case validation (2026-02-25)
- `~/Developer/swift-institute/Experiments/resumption-nonescapable-noncopyable/` -- Experiment: Resumption ~Copyable + ~Escapable (2026-03-02)
- `~/Developer/swift-institute/Experiments/conditional-escapable-container/` -- Experiment: Conditional Escapable containers (2026-03-02)
- `~/Developer/swift-institute/Experiments/nonescapable-gap-revalidation-624/` -- Experiment: Gap A/B re-validation on Swift 6.2.4 (2026-03-02)
- `~/Developer/swift-primitives/Experiments/nonescapable-edge-cases/` -- Experiment: ~Escapable edge cases (2026-02-28)
- `~/Developer/swift-institute/Experiments/pointer-nonescapable-storage/` -- Experiment: Exhaustive storage mechanism test including @_rawLayout (2026-03-02, v2.2.0)
- `~/Developer/swift-institute/Research/nonescapable-storage-mechanisms.md` -- Research: Storage mechanisms analysis including @_rawLayout gap (2026-03-02, v1.1.0)
