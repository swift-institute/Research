...
**Reproducer**: `swift-institute/Experiments/memory-cursor-generic-witness-demangle` (targets A–F + Outputs). Findings: `swift-institute/Research/memory-cursor-generic-witness-demangle-reshape.md` and `memory-contiguous-iteration-bridge.md` (Outcome OQ-2).
