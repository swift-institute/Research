...
- Experiment: `swift-identity-primitives/Experiments/tagged-view-struct/` — confirms Tagged.View struct approach
- Experiment: `swift-identity-primitives/Experiments/tagged-view-protocol/` — confirms Viewable protocol approach
