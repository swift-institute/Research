...
`Tagged<Tag, RawValue>` in `swift-identity-primitives` declares its primary
...
rationale is documented in `swift-identity-primitives/Research/comparative-analysis-pointfree-swift-tagged.md`
...
| swift-identity-primitives        | 70  | 2   | –  | 1  | –  | 16 | 1  | 41 | –  | 8  | Tagged itself lives here; experiments re-implement Tagged for alternative designs. |
...
|----------|----------------:|-------------|
| `test-fixture`                       | **308** | Every `2P`/`1P` site in `Tests/`, `Experiments/`, `TopLevel-Experiments/`, or `Research/` prototypes (168 + 104 + 30 + 6). Test-support literal conformances in `swift-identity-primitives/Tests/Support/…` and literal-shape tests are included. |
...
currently documented only at the Tagged source (`swift-identity-primitives/Research/comparative-analysis-pointfree-swift-tagged.md`
...
### Observation 7: `swift-identity-primitives`' experiments and tests disproportionately re-declare `Tagged` with variant signatures

41 of swift-identity-primitives' 70 sites are in `Experiments/`. Each
...
### Observation 8: Swift-level Tests re-use the literal `Identity Primitives Test Support` conformances

`swift-identity-primitives/Tests/Support/Identity Primitives Test Support.swift`
...
- `swift-identity-primitives/Research/comparative-analysis-pointfree-swift-tagged.md`
...
- `swift-identity-primitives/Research/tagged-literal-conformances.md`
