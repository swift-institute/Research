...
### Primary Sources
- `swift-identity-primitives/Research/tagged-literal-conformances.md` v2.0 — DECISION blocking production literal conformances
...
- `swift-identity-primitives/Research/revisiting-tagged-production-literal-conformances.md` — analysis of convention vs. literal conformance structural incompatibility
