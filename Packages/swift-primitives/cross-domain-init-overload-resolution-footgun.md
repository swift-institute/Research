...
**Component 2 — Blanket `ExpressibleByIntegerLiteral`** (`Identity Primitives Test Support.swift:16-21`):
...
- `swift-identity-primitives/Tests/Support/Identity Primitives Test Support.swift:16-21` — blanket `ExpressibleByIntegerLiteral` (enabler)
