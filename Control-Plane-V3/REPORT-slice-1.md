...
| Path | Commit |
|---|---|
| `~/Developer/swift-institute/Research/Control-Plane-V3/provenance-and-failure-corpus.md` | `3a91b4f` |
| `~/Developer/swift-institute/Research/Control-Plane-V3/design.md` | `3a91b4f`, amended `7d555e8` (flock deferral) |
| `~/Developer/swift-institute/Research/Control-Plane-V3/REPORT-slice-1.md` | this file |

**Prototype repository** (new local git repo, no remote):

| Path | Commits |
|---|---|
| `~/Developer/swift-institute/swift-control-plane/` | `da8b75e` (kernel + adapters + tests), `e66e3d7` (gate-green fixes; evidence in message) |
