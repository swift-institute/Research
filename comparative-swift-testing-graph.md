...
- `~/Developer/swift-primitives/swift-tree-primitives/` — Tree primitives (audit target)
- `~/Developer/swift-primitives/swift-graph-primitives/` — Graph primitives (comparison)
