...
- `~/Developer/CLAUDE.md`
- `~/Developer/swift-institute/CLAUDE.md`
...
|-----------|------|-------|
| swift-primitives | `~/Developer/swift-primitives/` | L1 (Primitives) |
| swift-standards | `~/Developer/swift-standards/` | L2 (Standards) |
| swift-foundations | `~/Developer/swift-foundations/` | L3 (Foundations) |
...
Write to: `~/Developer/swift-institute/Research/platform-compliance-audit.md`
