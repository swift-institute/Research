...
```
~/Developer/swift-primitives/swift-geometry-primitives/Sources/Geometry Primitives/Geometry.EdgeInsets.swift
```
...
```
~/Developer/swift-primitives/swift-algebra-primitives/
```
...
grep -rn "typealias Height\|typealias Width\|struct Height\|struct Width" \
  ~/Developer/swift-primitives/swift-geometry-primitives/Sources/
```
...
Location: `~/Developer/swift-primitives/swift-geometry-primitives/Experiments/insets-as-product/`
