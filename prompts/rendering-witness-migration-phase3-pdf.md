...
- `~/Developer/swift-primitives/swift-rendering-primitives/Sources/Rendering Primitives Core/Rendering.Context.swift`
- `~/Developer/swift-foundations/swift-html-rendering/Sources/HTML Renderable/Rendering.Context +HTML.swift`
...
**File**: `~/Developer/swift-foundations/swift-pdf-rendering/Sources/PDF Rendering/PDF.Context+Rendering.swift`
...
**File**: `~/Developer/swift-foundations/swift-pdf-html-rendering/Sources/PDF HTML Rendering/PDF.HTML.Context+Rendering.swift`
...
| File | Why |
|------|-----|
| Phase 1 Rendering.Context | `~/Developer/swift-primitives/swift-rendering-primitives/Sources/Rendering Primitives Core/Rendering.Context.swift` |
| Phase 2 HTML factory | `~/Developer/swift-foundations/swift-html-rendering/Sources/HTML Renderable/Rendering.Context +HTML.swift` |
| PDF.Context conformance | `~/Developer/swift-foundations/swift-pdf-rendering/Sources/PDF Rendering/PDF.Context+Rendering.swift` |
| PDF.HTML.Context conformance | `~/Developer/swift-foundations/swift-pdf-html-rendering/Sources/PDF HTML Rendering/PDF.HTML.Context+Rendering.swift` |
| PDF.HTML.Context main type | `~/Developer/swift-foundations/swift-pdf-html-rendering/Sources/PDF HTML Rendering/PDF.HTML.Context.swift` |
| PDF rendering Package.swift | `~/Developer/swift-foundations/swift-pdf-rendering/Package.swift` |
| PDF HTML rendering Package.swift | `~/Developer/swift-foundations/swift-pdf-html-rendering/Package.swift` |
...
```bash
# Package 1
cd ~/Developer/swift-foundations/swift-pdf-rendering
swift build
swift test

# Package 2
cd ~/Developer/swift-foundations/swift-pdf-html-rendering
swift build
swift test
```
...
```bash
cd ~/Developer/swift-foundations/swift-pdf
