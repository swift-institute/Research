...
```
~/Developer/swift-institute/Research/string-primitives-shadowing.md
```
...
```
~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Primitives Core/exports.swift
```
- Contains `@_exported public import String_Primitives` (guarded by `#if KERNEL_AVAILABLE`)

#### Research on the String type's purpose
```
~/Developer/swift-primitives/swift-string-primitives/Research/OS Native Path String Semantics.md
```
...
```
~/Developer/swift-foundations/swift-dependency-analysis/Sources/Dependency Analysis CLI/CLI.swift
~/Developer/swift-foundations/swift-dependency-analysis/Sources/Dependency Analysis CLI/parallel.swift
```
...
`swift-strings` at `~/Developer/swift-foundations/swift-strings/` is the primary consumer of `String_Primitives`. You MUST:
...
5. Check the Kernel target in swift-kernel (foundations layer):
   ```
   ~/Developer/swift-foundations/swift-kernel/Sources/Kernel/exports.swift
   ```
...
```
~/Developer/swift-primitives/swift-kernel-primitives/Package.swift
```
...
1. A research document at `~/Developer/swift-institute/Research/string-primitives-shadowing.md` following [RES-003] structure
2. Updated `_index.md` at `~/Developer/swift-institute/Research/_index.md`
...
| Repository | Path |
|------------|------|
| swift-primitives | `~/Developer/swift-primitives/` |
| swift-foundations | `~/Developer/swift-foundations/` |
| swift-standards | `~/Developer/swift-standards/` |
| swift-institute | `~/Developer/swift-institute/` |
| swift-string-primitives | `~/Developer/swift-primitives/swift-string-primitives/` |
| swift-kernel-primitives | `~/Developer/swift-primitives/swift-kernel-primitives/` |
| swift-path-primitives | `~/Developer/swift-primitives/swift-path-primitives/` |
| swift-loader-primitives | `~/Developer/swift-primitives/swift-loader-primitives/` |
| swift-kernel (foundations) | `~/Developer/swift-foundations/swift-kernel/` |
| swift-strings (foundations) | `~/Developer/swift-foundations/swift-strings/` |
| swift-io (foundations) | `~/Developer/swift-foundations/swift-io/` |
| swift-dependency-analysis | `~/Developer/swift-foundations/swift-dependency-analysis/` |
...
```
~/Developer/swift-primitives/swift-formatting-primitives/Package.swift
```
...
```
grep -r "KERNEL_AVAILABLE" ~/Developer/swift-primitives/swift-kernel-primitives/
```
