...
Primary:
- `~/Developer/swift-foundations/swift-file-system/`

Upstream (follow underscore chains into these when referenced):
- `~/Developer/swift-foundations/swift-kernel/`
- `~/Developer/swift-foundations/swift-paths/`
- `~/Developer/swift-foundations/swift-io/`
- `~/Developer/swift-primitives/swift-kernel-primitives/`
- `~/Developer/swift-primitives/swift-identity-primitives/`
...
Write findings to `~/Developer/swift-institute/Research/underscore-api-elimination-audit.md`. Return ONLY a one-line confirmation.
