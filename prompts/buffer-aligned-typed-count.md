...
```bash
grep -rn 'Buffer\.Aligned' ~/Developer/swift-standards/
grep -rn 'Buffer\.Aligned' ~/Developer/swift-foundations/
```

## Build & test

```bash
cd ~/Developer/swift-primitives/swift-buffer-primitives
