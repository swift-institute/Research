...
Read `~/Developer/swift-institute/Research/audits/implementation-naming-2026-03-20/01-remediation-plan.md` for full context. This prompt executes **Pass 4: Compound Type Renames**.
...
2. **Also grep cross-repo**: `grep -rn 'OldName' ~/Developer/swift-standards/*/Sources/ ~/Developer/swift-foundations/*/Sources/` — note cross-repo usage but do NOT fix it in this pass (separate follow-up)
