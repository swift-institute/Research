...
- `~/Developer/compile_commands.json` exists and is fresh
- `~/Developer/.sourcekit-lsp/config.json` has `defaultWorkspaceType: "compilationDatabase"`
...
```
find_definition(file_path="~/Developer/swift-primitives/swift-buffer-primitives/Sources/Buffer Primitives Core/Buffer.swift", symbol_name="Buffer", symbol_kind="enum")
find_definition(file_path="~/Developer/swift-standards/swift-iso-9899/Sources/ISO 9899 Core/ISO_9899.swift", symbol_name="ISO_9899", symbol_kind="enum")
find_definition(file_path="~/Developer/swift-foundations/swift-io/Sources/IO Primitives/IO.swift", symbol_name="IO", symbol_kind="enum")
```
...
```
get_hover(file_path="~/Developer/swift-primitives/swift-buffer-primitives/Sources/Buffer Primitives Core/Buffer.swift", line=19, character=13)
get_hover(file_path="~/Developer/swift-standards/swift-iso-9899/Sources/ISO 9899 Core/ISO_9899.swift", line=54, character=13)
get_hover(file_path="~/Developer/swift-foundations/swift-io/Sources/IO Primitives/IO.swift", line=14, character=13)
```
...
```
find_references(file_path="~/Developer/swift-primitives/swift-buffer-primitives/Sources/Buffer Primitives Core/Buffer.swift", symbol_name="Buffer", symbol_kind="enum")
find_references(file_path="~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Primitives Core/Kernel.swift", symbol_name="Kernel", symbol_kind="enum")
find_references(file_path="~/Developer/swift-primitives/swift-memory-primitives/Sources/Memory Primitives Core/Memory.swift", symbol_name="Memory", symbol_kind="enum")
find_references(file_path="~/Developer/swift-foundations/swift-io/Sources/IO Primitives/IO.swift", symbol_name="IO", symbol_kind="enum")
```
...
```
find_references(file_path="~/Developer/swift-primitives/swift-memory-primitives/Sources/Memory Primitives Core/Memory.Address.swift", symbol_name="Address")
```
...
```bash
~/Developer/regenerate-compile-commands.sh          # full rebuild + regenerate
~/Developer/regenerate-compile-commands.sh --fast   # regenerate from existing build
```

## Architecture

- **Compilation database**: `~/Developer/compile_commands.json` (3413 entries, 408 modules, 3 layers)
- **Index store**: `~/Developer/swift-foundations/swift-io/.build/arm64-apple-macosx/debug/index/store/v5/` (50MB, 2923 units)
