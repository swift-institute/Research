...
- **swift-paths**: `~/Developer/swift-foundations/swift-paths/`
- **swift-file-system**: `~/Developer/swift-foundations/swift-file-system/`
...
Write findings to `~/Developer/swift-institute/Research/file-path-type-unification-audit.md`. Return ONLY a one-line confirmation: "Wrote file-path-type-unification-audit.md".
