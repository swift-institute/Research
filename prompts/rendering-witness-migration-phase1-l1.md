...
**Current** (protocol, 262 lines): `~/Developer/swift-primitives/swift-rendering-primitives/Sources/Rendering Primitives Core/Rendering.Context.swift`
...
```bash
cd ~/Developer/swift-foundations
...
`~/Developer/swift-institute/Experiments/rendering-witness-migration-blockers/`
...
`~/Developer/swift-primitives/swift-rendering-primitives/Package.swift`
