...
Read the CLAUDE.md at `~/Developer/CLAUDE.md` and `~/Developer/swift-primitives/CLAUDE.md`.

## Background

`Either<Left, Right>` was added to swift-algebra-primitives as the canonical binary coproduct. It lives at:
`~/Developer/swift-primitives/swift-algebra-primitives/Sources/Algebra Primitives/Either.swift`
...
Package: `~/Developer/swift-primitives/swift-parser-primitives/`
...
```bash
cd ~/Developer/swift-primitives/swift-parser-primitives
swift build
swift test
```
