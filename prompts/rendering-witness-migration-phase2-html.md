...
**Read the Phase 1 code before starting**: `~/Developer/swift-primitives/swift-rendering-primitives/Sources/Rendering Primitives Core/`
...
```bash
cd ~/Developer/swift-foundations/swift-html-rendering
...
```bash
cd ~/Developer/swift-foundations/swift-markdown-html-rendering
...
- Follow the exact patterns from the validated experiment: `~/Developer/swift-institute/Experiments/rendering-witness-migration-blockers/`
