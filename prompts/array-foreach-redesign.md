...
- `~/Developer/swift-primitives/swift-array-primitives/Sources/Array Primitives Core/Array.Protocol.swift`
- `~/Developer/swift-primitives/swift-array-primitives/Sources/Array Primitives Core/Array.Protocol+defaults.swift`
- `~/Developer/swift-primitives/swift-array-primitives/Sources/Array Dynamic Primitives/Array.Dynamic ~Copyable.swift` (forEach property)

**Collection iteration infrastructure**:
- `~/Developer/swift-primitives/swift-collection-primitives/Sources/Collection Primitives/Collection.Protocol+ForEach.swift`
- `~/Developer/swift-primitives/swift-collection-primitives/Sources/Collection Primitives/Collection.ForEach+Property.View.swift`
- `~/Developer/swift-primitives/swift-collection-primitives/Sources/Collection Primitives/Collection.ForEach.swift`

**Other Array variants** (also have forEach properties):
- `~/Developer/swift-primitives/swift-array-primitives/Sources/Array Fixed Primitives/Array.Fixed ~Copyable.swift`
- `~/Developer/swift-primitives/swift-array-primitives/Sources/Array Static Primitives/Array.Static ~Copyable.swift`
- `~/Developer/swift-primitives/swift-array-primitives/Sources/Array Small Primitives/Array.Small ~Copyable.swift`

**Swift stdlib reference**:
- `~/Developer/swiftlang/swift/stdlib/public/core/Sequence.swift` (lines 850-858)

**Consumer showing the problem**:
- `~/Developer/rule-law/rule-law-nl/rule-burgerlijk-wetboek-2/Sources/Rule Burgerlijk Wetboek 2/Besloten Vennootschap.Aandeelhoudersregister.swift`
...
Write research document to `~/Developer/swift-primitives/swift-array-primitives/Research/array-foreach-redesign.md`. Follow [RES-003] structure. Include ecosystem usage scan results and migration cost.
