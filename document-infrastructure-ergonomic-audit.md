...
- rule-law ARCHITECTURE.md: `~/Developer/rule-law/ARCHITECTURE.md`
- coenttb/swift-documents: `~/Developer/coenttb/swift-documents/`
- coenttb/swift-document-templates: `~/Developer/coenttb/swift-document-templates/`
- rule-legal-document-templates: `~/Developer/rule-legal/rule-legal-document-templates/`
- PDF.HTML.Configuration: `~/Developer/swift-foundations/swift-pdf-html-rendering/Sources/PDF HTML Rendering/PDF.HTML.Configuration.swift`
