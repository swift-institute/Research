...
**Path**: `~/Developer/swift-institute/Experiments/noncopyable-nested-deinit-chain/`
...
- **Experiment**: `~/Developer/swift-institute/Experiments/noncopyable-nested-deinit-chain/`
- **Queue.Static workaround**: `~/Developer/swift-primitives/swift-queue-primitives/Sources/Queue Primitives Core/Queue.Static.swift`
- **Queue.DoubleEnded.Static workaround**: `~/Developer/swift-primitives/swift-queue-primitives/Sources/Queue Primitives Core/Queue.DoubleEnded.Static.swift`
- **Buffer canary tests**: `~/Developer/swift-primitives/swift-buffer-primitives/Tests/Buffer Ring Inline Primitives Tests/Buffer.Ring.Inline Canary Tests.swift`
- **Storage inline deinit research**: `~/Developer/swift-primitives/swift-storage-primitives/Research/inline-deinit-ownership.md`
