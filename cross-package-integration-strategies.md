...
| [intra-package-modularization-patterns.md](~/Developer/swift-primitives/Research/intra-package-modularization-patterns.md) | 13 patterns for targets within a single Package.swift | Codifies the intra-package solution (Problem 1) |
| [finite-collection-join-point-integration.md](~/Developer/swift-primitives/Research/finite-collection-join-point-integration.md) | Recommended separate integration package; NOT_PURSUED due to CaseIterable | Shows cross-package integration can be impractical when protocol constraints couple the packages |
...
- [intra-package-modularization-patterns.md](~/Developer/swift-primitives/Research/intra-package-modularization-patterns.md) — 13 intra-package patterns
- [finite-collection-join-point-integration.md](~/Developer/swift-primitives/Research/finite-collection-join-point-integration.md) — Finite × Collection case study
