...
#### swift-locale-primitives (`~/Developer/swift-primitives/swift-locale-primitives/`)
...
#### swift-formatting-primitives (`~/Developer/swift-primitives/swift-formatting-primitives/`)
...
#### swift-time-primitives (`~/Developer/swift-primitives/swift-time-primitives/`)
...
#### swift-locale-standard (`~/Developer/swift-standards/swift-locale-standard/`)
...
#### swift-time-standard (`~/Developer/swift-standards/swift-time-standard/`)
...
#### swift-locale (`~/Developer/swift-foundations/swift-locale/`)

**Status**: Pure re-export.

Single file `exports.swift` re-exporting `Locale_Standard`. No additional API.

#### swift-translating (`~/Developer/swift-foundations/swift-translating/`)
...
#### swift-time (`~/Developer/swift-foundations/swift-time/`)
...
- Prior research: `~/Developer/swift-institute/Research/foundation-free-time-and-locale-in-swift-translating.md` (Option C recommendation)
- Apple swift-foundation ICU pattern: `~/Developer/swiftlang/swift-foundation/Sources/FoundationInternationalization/`
- Triggering file: `~/Developer/rule-legal/rule-legal-nl/rule-besloten-vennootschap/Sources/Aandeelhoudersregister PDF/Time+Formatting.swift`
- L2 Locale: `~/Developer/swift-standards/swift-locale-standard/Sources/Locale Standard/`
- L3 Translating: `~/Developer/swift-foundations/swift-translating/Sources/`
- L1 Formatting: `~/Developer/swift-primitives/swift-formatting-primitives/Sources/Formatting Primitives/`
- L1 Time: `~/Developer/swift-primitives/swift-time-primitives/Sources/Time Primitives Core/`
