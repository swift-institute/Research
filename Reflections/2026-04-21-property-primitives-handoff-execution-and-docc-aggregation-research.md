...
| `~/Developer/HANDOFF.md` | out-of-session-scope — not authored, not worked, not touched |
| `~/Developer/HANDOFF-executor-main-platform-runloop.md` | out-of-session-scope |
| `~/Developer/HANDOFF-io-completion-migration.md` | out-of-session-scope |
| `~/Developer/HANDOFF-migration-audit.md` | out-of-session-scope |
| `~/Developer/HANDOFF-path-decomposition.md` | out-of-session-scope |
| `~/Developer/HANDOFF-primitive-protocol-audit.md` | out-of-session-scope |
| `~/Developer/HANDOFF-worker-id-typed-retype.md` | out-of-session-scope |
| `~/Developer/swift-institute/HANDOFF-string-correction-cycle.md` | out-of-session-scope |
| `~/Developer/swift-institute/HANDOFF-typed-time-clock-cleanup.md` | out-of-session-scope |
| `~/Developer/swift-institute/HANDOFF-windows-kernel-string-parity.md` | out-of-session-scope |
