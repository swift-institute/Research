...
`~/Developer/bytedance/DanceUI` and its sibling repos
...
`~/Developer/HANDOFF-package-noun-rename.md` for the rename
...
**HANDOFF scan:** 7 handoff files at `~/Developer/`. 1 written
...
- **Working-directory git trap.** `~/Developer` is not a
