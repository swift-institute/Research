...
> Read `~/Developer/swift-institute/Research/audits/implementation-naming-2026-03-20/01-remediation-plan.md` and execute Pass N. Work tier 0 → tier 20. For each tier, edit the code, run `swift build && swift test`, fix any downstream breakage at the next tier, and commit per tier.
