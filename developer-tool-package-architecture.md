...
Independent Swift packages at `~/Developer/swift-{tool-name}/`. Not part of any super-repo. Use SwiftPM for structure, ArgumentParser for CLI, and can be built/tested independently.
...
- Existing bash prototype: `~/Developer/detect-redundant-deps.sh`
