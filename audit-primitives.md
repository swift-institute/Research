...
`~/Developer/swift-primitives/swift-queue-primitives/Sources/Queue Primitives Core/Queue.Error.swift`
...
`~/Developer/swift-primitives/swift-set-primitives/Sources/Set Primitives Core/Set.Ordered.Error.swift`
...
`~/Developer/swift-primitives/swift-dictionary-primitives/Sources/Dictionary Primitives Core/Dictionary.Ordered.Error.swift`
...
`~/Developer/swift-primitives/swift-list-primitives/Sources/List Primitives Core/List.Linked.Error.swift`
...
`~/Developer/swift-primitives/swift-stack-primitives/Sources/Stack Primitives Core/Stack.Error.swift`
...
`~/Developer/swift-primitives/swift-handle-primitives/Sources/Handle Primitives/SlotAddress.swift:31`
...
`~/Developer/swift-primitives/swift-binary-primitives/Sources/Binary Format Primitives/Binary.Format.Radix.swift:74`
...
`~/Developer/swift-primitives/swift-test-primitives/Sources/Test Snapshot Primitives/Test.Snapshot.Diff.Result.StructuralOperation.swift:26`
...
`~/Developer/swift-primitives/swift-vector-primitives/Sources/Vector Primitives Core/Vector.swift`
...
`~/Developer/swift-primitives/swift-ordinal-primitives/Sources/Ordinal Primitives Core/Ordinal.swift`
...
All in `~/Developer/swift-primitives/swift-linux-primitives/Sources/Linux Kernel Primitives/`:
...
All in `~/Developer/swift-primitives/swift-windows-primitives/Sources/Windows Kernel Primitives/`:
...
`~/Developer/swift-primitives/swift-darwin-primitives/Sources/Darwin Kernel Primitives/Darwin.Kernel.Kqueue.swift`
