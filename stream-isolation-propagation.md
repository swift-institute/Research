...
- `~/Developer/swift-institute/Experiments/nonsending-blocker-validation/` — Empirical validation: nonsending async closures, continuation/cancellation handler isolation
- `~/Developer/swift-institute/Experiments/nonsending-blocker-validation-negative/` — Negative validation: compiler rejects nonsending on sync function types
