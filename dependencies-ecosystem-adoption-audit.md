...
1. **HTML.Context.Configuration as Dependency.Key**
   - File: `~/Developer/swift-foundations/swift-html-rendering/Sources/HTML Renderable/HTML.Context.Configuration.swift`
...
2. **HTML.Element.Style.Context as Dependency.Key**
   - File: `~/Developer/swift-foundations/swift-html-rendering/Sources/HTML Renderable/HTML.Style.Context.swift`
   - Replace `@TaskLocal public static var current` with a `Dependency.Key` conformance
