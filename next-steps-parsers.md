...
```bash
cd ~/Developer/swift-standards/swift-rfc-9110 && swift build && swift test
```
...
```bash
cd ~/Developer/swift-standards/swift-rfc-3986 && swift build && swift test
```
...
```bash
cd ~/Developer/swift-standards/swift-iso-8601 && swift build && swift test
```
...
After all: `cd ~/Developer/swift-standards && swift build` (full monorepo build).
...
```bash
cd ~/Developer/swift-standards/swift-rfc-9112
...
7. **Build monorepo** — `cd ~/Developer/swift-standards && swift build` to catch cross-package breakage
