...
Read `~/Developer/swift-institute/Research/naming-implementation-audit-swift-tests-swift-testing.md` — this is the full audit of swift-tests and swift-testing against the `/naming` and `/implementation` skills. 88 violations identified, organized by priority.
