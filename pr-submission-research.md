...
- `~/Developer/swiftlang/swift/CONTRIBUTING.md`
- `~/Developer/swiftlang/swift/docs/HowToGuides/FirstPullRequest.md`
- `~/Developer/swiftlang/swift/docs/HowToGuides/GettingStarted.md` (lines 345-367)
- `~/Developer/swiftlang/swift/docs/ContinuousIntegration.md`
- `~/Developer/swiftlang/swift/.github/CODEOWNERS`
