...
- `~/Developer/swift-institute/swift-institute.org/HANDOFF.md` — supervisor ground rules and handoff context
- `~/Developer/swift-institute/swift-institute.org/Swift Institute.docc/Research.md`
- `~/Developer/swift-institute/swift-institute.org/Swift Institute.docc/Experiments.md`
- `~/Developer/swift-institute/swift-institute.org/Swift Institute.docc/Layers.md`
