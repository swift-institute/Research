...
| Local repo dirs | `~/Developer/swift-primitives/` → `~/Developer/reality-primitives/` | — |
...
32. Five Layer Architecture. `~/Developer/swift-institute/Documentation.docc/Five Layer Architecture.md`
33. Semantic Dependencies. `~/Developer/swift-institute/Documentation.docc/Semantic Dependencies.md`
34. Primitives Taxonomy Naming and Layering Audit. `~/Developer/swift-primitives/Research/primitives-taxonomy-naming-layering-audit.md`
35. Identity: Why "Institute". `~/Developer/swift-institute/Documentation.docc/Identity.md`
36. Prior Art Scratch Notes. `~/Developer/swift-institute/Research/_scratch-domain-first-prior-art.md`
