...
**Toolchain bundle ID resolution**: `defaults read ~/Library/Developer/Toolchains/swift-DEVELOPMENT-SNAPSHOT-2026-03-16-a.xctoolchain/Info CFBundleIdentifier` → `org.swift.64202603161a`.
