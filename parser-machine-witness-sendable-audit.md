...
File: `~/Developer/swift-primitives/swift-parser-machine-primitives/Sources/Parser Machine Compile Primitives/Parser.Machine.Compile.Witness.swift`
...
4. No tests need modification -- the existing test suite at `~/Developer/swift-primitives/swift-parser-machine-primitives/Tests/Parser Machine Compile Primitives Tests/` covers compilation and prepared parsing but does not test Sendable or cross-task behavior (correctly, since neither applies).
...
- `Witness.Protocol` definition: `~/Developer/swift-primitives/swift-witness-primitives/Sources/Witness Primitives/Witness.Protocol.swift`
- `Compile.Witness` source: `~/Developer/swift-primitives/swift-parser-machine-primitives/Sources/Parser Machine Compile Primitives/Parser.Machine.Compile.Witness.swift`
- `Compiled` source: `~/Developer/swift-primitives/swift-parser-machine-primitives/Sources/Parser Machine Compile Primitives/Parser.Machine.Compiled.swift`
- `Prepared` source: `~/Developer/swift-primitives/swift-parser-machine-primitives/Sources/Parser Machine Compile Primitives/Parser.Machine.Prepared.swift`
- Related research: `~/Developer/swift-institute/Research/witness-noncopyable-nonescapable-support.md`
- Primitives tier map: `~/Developer/swift-primitives/Documentation.docc/Primitives Tiers.md` (parser-machine at tier 20, witness at tier 2)
