...
- serialization-primitives witnesses: `~/Developer/swift-primitives/swift-serialization-primitives/Sources/Serialization Primitives/`
...
- parser-bridge-architecture plan: `~/.claude/plans/cuddly-painting-wilkinson.md`
