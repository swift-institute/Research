...
- binary-parser-primitives reference architecture: `~/Developer/swift-primitives/swift-binary-parser-primitives/`
- ascii-primitives current API: `~/Developer/swift-primitives/swift-ascii-primitives/Sources/ASCII Primitives/`
- parser-primitives ASCII target: `~/Developer/swift-primitives/swift-parser-primitives/Sources/Parser ASCII Integer Primitives/`
- parser-primitives protocols: `~/Developer/swift-primitives/swift-parser-primitives/Sources/Parser Primitives Core/`
- swift-ascii foundations: `~/Developer/swift-foundations/swift-ascii/Sources/ASCII/`
- Primitives Tiers: `~/Developer/swift-primitives/Documentation.docc/Primitives Tiers.md`
