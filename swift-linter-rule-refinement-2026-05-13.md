...
dispatch_handoff: ~/Developer/HANDOFF-swift-linter-rule-refinement.md
triage_note: |
...
- HANDOFF dispatch: `~/Developer/HANDOFF-swift-linter-rule-refinement.md`
...
```bash
cd <wave-2-package> && \
SWIFT_LINTER_PATH=~/Developer/swift-foundations/swift-linter \
~/Developer/swift-foundations/swift-linter/.build/debug/swift-linter
```
