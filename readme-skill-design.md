...
- `~/Developer/swift-institute/Research/documentation-skill-design.md` — Parent research (separation decision)
- `~/Developer/swift-institute/Documentation.docc/Documentation Standards.md` — Existing README specifications
- `~/Developer/swift-institute/Skills/documentation/SKILL.md` — Companion skill
