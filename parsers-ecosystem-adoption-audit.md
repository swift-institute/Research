...
The core protocol at `~/Developer/swift-primitives/swift-parser-primitives/Sources/Parser Primitives Core/Parser.Parser.swift`:
...
At `~/Developer/swift-foundations/swift-parsers/Sources/Parsers/`:
...
At `~/Developer/swift-primitives/swift-binary-parser-primitives/Sources/`:
...
At `~/Developer/swift-primitives/swift-parser-machine-primitives/Sources/`:
