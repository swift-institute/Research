...
- **`~/Developer/HANDOFF-classification-extension-tier-1.md`** — branching investigation handoff that dispatched this work. Supervisor ground-rules block honored; verification stamp at §Outcome.
...
`~/Developer/HANDOFF-classification-extension-tier-1.md` — branching investigation handoff that dispatched this work; supervisor ground-rules block honored; verification stamp in §Outcome.
