...
- `~/Developer/swift-primitives/.swift-format` — swift-primitives root config (read 2026-05-05).
...
- `~/Developer/HANDOFF-mechanical-rule-tool-classification.md` — dispatch brief (this dispatch's source).
