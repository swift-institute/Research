...
```bash
cd ~/Developer/swift-primitives && swift build 2>&1 | grep -c 'SemanticCopies\|DynamicExclusivity'
cd ~/Developer/swift-foundations && swift build 2>&1 | grep -c 'SemanticCopies\|DynamicExclusivity'
```
