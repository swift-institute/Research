...
**swift-kernel-primitives** (Layer 1, `~/Developer/swift-primitives/swift-kernel-primitives/`):
...
**swift-kernel** (Layer 3, `~/Developer/swift-foundations/swift-kernel/`):
...
**swift-darwin-primitives** (Layer 1, `~/Developer/swift-primitives/swift-darwin-primitives/`):
...
**swift-linux-primitives** (Layer 1, `~/Developer/swift-primitives/swift-linux-primitives/`):
...
**swift-cpu-primitives** (Layer 1, `~/Developer/swift-primitives/swift-cpu-primitives/`):
...
**swift-darwin** / **swift-linux** / **swift-posix** (Layer 3, `~/Developer/swift-foundations/`):
...
**swift-system-primitives** (Layer 1, `~/Developer/swift-primitives/swift-system-primitives/`):
...
- Kernel.Thread.Executor: `~/Developer/swift-foundations/swift-kernel/Sources/Kernel Thread/Kernel.Thread.Executor.swift`
- Kernel.Thread.Synchronization: `~/Developer/swift-foundations/swift-kernel/Sources/Kernel Thread/Kernel.Thread.Synchronization.swift`
- Kernel.Thread.spawn: `~/Developer/swift-foundations/swift-kernel/Sources/Kernel Thread/Kernel.Thread.spawn.swift`
- Kernel.Thread.Worker: `~/Developer/swift-foundations/swift-kernel/Sources/Kernel Thread/Kernel.Thread.Worker.swift`
- Kernel.Continuation.Context: `~/Developer/swift-foundations/swift-kernel/Sources/Kernel Continuation/Kernel.Continuation.Context.swift`
- Kernel.Descriptor: `~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Descriptor Primitives/Kernel.Descriptor.swift`
- Kernel.Syscall.Rule: `~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Syscall Primitives/Kernel.Syscall.swift`
- Kernel.Environment.Entry: `~/Developer/swift-primitives/swift-kernel-primitives/Sources/Kernel Environment Primitives/Kernel.Environment.Entry.swift`
- Darwin.Kernel.Kqueue: `~/Developer/swift-primitives/swift-darwin-primitives/Sources/Darwin Kernel Primitives/Darwin.Kernel.Kqueue.swift`
- CPU.Atomic: `~/Developer/swift-primitives/swift-cpu-primitives/Sources/CPU Primitives/CPU.Atomic.Load.Operations.swift`
- POSIX.Kernel.IO.Write: `~/Developer/swift-foundations/swift-posix/Sources/POSIX Kernel/POSIX.Kernel.IO.Write.swift`
- Kernel.Thread.Worker.Token: `~/Developer/swift-foundations/swift-kernel/Sources/Kernel Thread/Kernel.Thread.Worker.Token.swift`
