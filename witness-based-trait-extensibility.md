...
- `swift-witnesses` source: `~/Developer/swift-foundations/swift-witnesses/Sources/Witnesses/`
- `swift-test-primitives` trait types: `~/Developer/swift-primitives/swift-test-primitives/Sources/Test Primitives Core/Test.Trait.Kind.swift`
- `swift-tests` runner: `~/Developer/swift-foundations/swift-tests/Sources/Tests Core/Test.Runner.swift` (lines 160-223 -- `runWithTraits` method)
- `swift-tests` exclusive trait: `~/Developer/swift-foundations/swift-tests/Sources/Tests Core/Test.Trait.Exclusive.swift`
- `swift-tests` timed trait: `~/Developer/swift-foundations/swift-tests/Sources/Tests Performance/Test.Trait.Timed.swift`
