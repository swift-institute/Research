...
Read these in order for full context. All in `~/Developer/swift-institute/Research/`:
...
```
~/Developer/swift-primitives/swift-ascii-parser-primitives/
~/Developer/swift-primitives/swift-ascii-serializer-primitives/
```

### Modified packages
```
~/Developer/swift-primitives/swift-ascii-primitives/
~/Developer/swift-primitives/swift-parser-primitives/
~/Developer/swift-primitives/swift-serializer-primitives/
```

### Coder package (pre-existing, has uncommitted changes)
```
~/Developer/swift-primitives/swift-coder-primitives/
```

### Research documents
```
~/Developer/swift-institute/Research/transformation-domain-architecture.md
~/Developer/swift-institute/Research/parsing-serialization-capability-organization.md
~/Developer/swift-institute/Research/ascii-parsing-domain-ownership.md
~/Developer/swift-institute/Research/ascii-parsing-adversarial-review.md
~/Developer/swift-institute/Research/ascii-serialization-migration.md
~/Developer/swift-institute/Research/canonical-witness-capability-attachment.md
~/Developer/swift-institute/Research/parsers-ecosystem-adoption-audit.md
~/Developer/swift-institute/Research/parsers-adoption-implementation-plan.md
~/Developer/swift-institute/Research/next-steps-parsers.md
```

### Reference architecture
```
~/Developer/swift-primitives/swift-binary-parser-primitives/
```
...
```bash
# New packages
cd ~/Developer/swift-primitives/swift-ascii-parser-primitives && swift build && swift test
cd ~/Developer/swift-primitives/swift-ascii-serializer-primitives && swift build && swift test

# Modified packages
cd ~/Developer/swift-primitives/swift-parser-primitives && swift build && swift test
cd ~/Developer/swift-primitives/swift-serializer-primitives && swift build && swift test

# Search for stale references
grep -r "Parser\.ASCII\|Parser_ASCII_Integer\|Serializer\.ASCII\|Serializer_ASCII_Integer" ~/Developer/swift-primitives/ --include="*.swift" -l
grep -r "Parser\.ASCII\|Parser_ASCII_Integer\|Serializer\.ASCII\|Serializer_ASCII_Integer" ~/Developer/swift-standards/ --include="*.swift" -l
grep -r "Parser\.ASCII\|Parser_ASCII_Integer\|Serializer\.ASCII\|Serializer_ASCII_Integer" ~/Developer/swift-foundations/ --include="*.swift" -l
```
