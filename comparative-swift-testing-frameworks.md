...
- `~/Developer/swift-institute/Skills/testing/skill.md` — Testing skill (canonical)
- `~/Developer/swift-institute/Documentation.docc/Testing Requirements.md` — Testing requirements documentation
- `~/Developer/swift-foundations/swift-testing/` — Institute swift-testing source
- `~/Developer/swiftlang/swift-testing/` — Apple swift-testing source
