...
**Date**: 2026-03-19
**Scope**: All repos under `~/Developer/` that import `File_System`, `File_System_Primitives`, `Paths`, or `Path_Primitives` — excluding `swift-file-system` and `swift-paths` source/test files.
